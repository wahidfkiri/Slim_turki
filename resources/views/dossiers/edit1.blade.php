            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Modifier Dossier</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                         <form action="{{ route('dossiers.update', ['dossier' => $dossier]) }}" method="POST" id="dossierForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                            <div class="card-body">
                                <!-- Alert Messages -->
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" class="form-control @error('date_entree') is-invalid @enderror" 
                                                                       ...
                                                                       value="{{ $dossier->date_entree ? $dossier->date_entree->format('Y-m-d') : '' }}" required>
                                                                @error('date_entree')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control @error('objet') is-invalid @enderror" 
                                                                          id="objet" name="objet" 
                                                                          rows="4" placeholder="Description détaillée de l'objet du dossier">{{$dossier->objet }}</textarea>
                                                                @error('objet')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control @error('chambre') is-invalid @enderror" 
                                                                    ...
                                                                    <option value="civil" {{ $dossier->chambre == 'civil' ? 'selected' : '' }}>Civil</option>
                                                                    <option value="commercial" {{ $dossier->chambre == 'commercial' ? 'selected' : '' }}>Commercial</option>
                                                                    <option value="social" {{ $dossier->chambre == 'social' ? 'selected' : '' }}>Social</option>
                                                                    <option value="pénal" {{ $dossier->chambre == 'pénal' ? 'selected' : '' }}>Pénal</option>
                                                                </select>
                                                                @error('chambre')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('numero_instruction') is-invalid @enderror" 
                                                                       ...
                                                                       value="{{ $dossier->numero_instruction }}" 
                                                                ...
                                                                <select class="form-control @error('client_id') is-invalid @enderror" 
                                                                    ...
                                                                    @foreach($intervenants as $intervenant)
                                                                        @if($intervenant->categorie == 'client')
                                                                            <option value="{{ $intervenant->id }}" {{ $dossier->intervenants->first()->id == $intervenant->id ? 'selected' : '' }}>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control @error('avocat_id') is-invalid @enderror" 
                                                                    ...
                                                                    @foreach($users as $user)
                                                                        @if($user->fonction == 'admin' || $user->fonction == 'avocat')
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        ...
                                        <button type="submit" id="submitDossier" class="btn btn-primary">
                                            <i class="fas fa-save"></i> Modifier le dossier
                                        </button>
                                    </div>
                                </div>
